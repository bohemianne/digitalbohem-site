...
// WhatsApp kayan butonu
(function () {
  const btn = document.createElement('a');
  btn.href = 'https://wa.me/905307732270?text=Merhaba%2C%20dijital%20d%C3%BC%C4%9F%C3%BCn%20davetiyesi%20hakk%C4%B1nda%20bilgi%20almak%20istiyorum.';
  btn.target = '_blank';
  btn.rel = 'noopener';
  btn.className = 'wa-btn';
  btn.setAttribute('aria-label', 'WhatsApp ile iletişim');
  btn.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="28" height="28" fill="white">
